  ...
  const steps = [
    {
      ...
      techniques: ['Port Scanning', 'Service Enumeration', 'Subdomain Discovery', 'Technology Fingerprinting']
    },
    {
      number: '02',
      icon: <Icons.Target />,
      ...
      techniques: ['CVE Research', 'Configuration Review', 'OWASP Top 10 Analysis', 'Authentication Testing']
    },
    {
      number: '03',
      icon: <Icons.Terminal />,
      ...
      techniques: ['SQL Injection', 'Cross-Site Scripting', 'Authentication Bypass', 'Privilege Escalation']
    },
    {
      number: '04',
      icon: <Icons.Code />,
      ...
      techniques: ['Data Extraction', 'Lateral Movement', 'Persistence Testing', 'Impact Assessment']
    },
    {
      number: '05',
      icon: <Icons.Document />,
      ...
      techniques: ['Executive Summary', 'Technical Details', 'Risk Ratings', 'Remediation Steps']
    },
  ];
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {step.techniques.map((tech, j) => (
                      <span 
                        key={j} 
                        className="px-3 py-1 bg-emerald-500/10 text-emerald-500 text-xs font-mono border border-emerald-500/20"
                      >
                        {tech}
                      </span>
                    ))}
  ...
  const team = [
    {
      ...
      skills: ['Web Security', 'Red Teaming', 'OSINT', 'Python'],
      initial: 'N'
    },
    {
      name: 'Nico',
      ...
      skills: ['Machine Learning', 'Python', 'Tool Development', 'Automation'],
      initial: 'N'
    }
  ];
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {member.skills.map((skill, j) => (
                    <span 
                      key={j} 
                      className={`px-2 py-1 bg-emerald-500/10 text-emerald-500 text-xs font-mono transition-all duration-300 ${
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <button className="group relative w-full py-4 bg-emerald-500 text-black font-mono font-bold tracking-wider overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/50">
          ...
          <div className="space-y-6">
            {[
              ...
              { icon: <Icons.Key />, label: 'SECURE CONTACT', value: 'PGP key available on request' },
            ].map((item, i) => {
              const [ref, isVisible] = useScrollReveal(0.1);
              return (
                <div 
    ...
    <footer className="py-12 px-6 border-t border-emerald-500/20 relative">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-6 font-mono text-sm">
          <a href="#" className="text-gray-600 hover:text-emerald-500 transition-colors">Privacy</a>
          <a href="#" className="text-gray-600 hover:text-emerald-500 transition-colors">Terms</a>
        </div>
